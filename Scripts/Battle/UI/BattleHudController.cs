...
public partial class BattleHudController : CanvasLayer
{
	...
	private const float CardWidth = 90.0f;
	private const float CardHeight = 84.0f;
	private const float HandLeftPadding = 2.0f;
	private const float PreferredCardSpacing = 8.0f;
	private const float MaxCardSpacing = 12.0f;
	private const float MinCardSpacing = -82.0f;
	private const float PilePreviewCardWidth = 92.0f;
